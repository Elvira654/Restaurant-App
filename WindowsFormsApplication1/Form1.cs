...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'appData.Narudzba' table. You can move, or remove it, as needed.
            this.narudzbaTableAdapter.Fill(this.appData.Narudzba);
            narudzbaBindingSource.DataSource = this.appData.Narudzba;
        ...
        private void dataGridView1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Jeste li sigurni da želite obrisati ovo?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                 }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                narudzbaBindingSource.EndEdit();
                narudzbaTableAdapter.Update(this.appData.Narudzba);
                panel5.Enabled = false;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                narudzbaBindingSource.ResetBindings(false);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                panel5.Enabled = true;
                textBox9.Focus();
                this.appData.Narudzba.AddNarudzbaRow(this.appData.Narudzba.NewNarudzbaRow());
                narudzbaBindingSource.MoveLast();
